...
- [Module R circuit description](../../circuit-description/modules/r-drive-processor.md) — chapter 7 gives module Q no section of its own; its RC5 circuit is described with module R, whose sheet carries it
